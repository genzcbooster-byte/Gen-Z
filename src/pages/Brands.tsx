    ...
    <div className="bg-black min-h-screen py-[6rem] px-[1.5em] md:px-[5em] overflow-hidden">
      <div className="flex flex-col items-center text-center mb-[4rem]">
        <motion.h1 
          ...
          className="font-canela text-[4rem] md:text-[6.5rem] lg:text-[8rem] font-bold leading-none tracking-tight text-white mb-4"
        >
          {brandsData.hero_title || "BRANDS."}
        </motion.h1>
        <p className="text-cyan-400 font-soehne text-[0.95rem] tracking-widest uppercase font-bold">{brandsData.hero_subtitle || "// THE FORCE BEHIND THE MOVEMENTS."}</p>
      </div>
      ...
      <div className="mt-[5rem] brutal-card p-[3em] bg-purple-600 text-white text-center relative overflow-hidden">
        ...
        <h2 className="font-canela text-[3rem] md:text-[4rem] lg:text-[5rem] font-bold tracking-tight relative z-10 leading-none mb-6">{brandsData.cta_heading || "WANT TO BE THE NEXT HEX?"}</h2>
